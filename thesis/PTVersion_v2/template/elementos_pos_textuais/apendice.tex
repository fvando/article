...
\begin{itemize}
    \item \textbf{\textbf{Critério de otimalidade relativa:} tolerância implícita configurada
por limite de tempo e critérios internos do CP-SAT.}.  
    \item \textbf{MaxTime:} 600 segundos (10 minutos).  
    \item \textbf{Presolve:} ativado.  
    \item \textbf{Cuts:} automáticas.  
    \item \textbf{Heurísticas internas do CP-SAT:} ativadas automaticamente
(busca guiada por SAT, propagação de restrições e heurísticas de viabilidade)  
\end{itemize}
