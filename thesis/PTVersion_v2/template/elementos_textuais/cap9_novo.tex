...
Este capítulo apresenta uma síntese integrada do trabalho desenvolvido, consolida os principais resultados obtidos, valida as contribuições científicas anunciadas no Capítulo~\ref{cap:revisao}, explicita as limitações identificadas e delineia caminhos promissores para pesquisas futuras.
