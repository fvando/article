...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{template/figuras/demanda_capacidade_exact.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{template/figuras/demanda_capacidade_lns.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{template/figuras/workload_distribution_lns.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{template/figuras/allocation_heatmap_lns.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{template/figuras/lns_convergence.pdf}
    \caption{Trajetória de convergência do LNS em cenário de 7 dias.}
