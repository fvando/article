...
Para cada vizinhança liberada, é formulado um subproblema de Programação Linear Inteira, resolvido por meio da mesma estratégia lexicográfica em duas fases (cobertura e eficiência) descrita para o modo exato. Essa abordagem garante que o refinamento local priorize sempre a estabilidade operacional antes da redução de recursos, mantendo a consistência com a filosofia global de otimização do simulador.
