...
\tipotrabalho{Exame de Qualificação de Mestrado} % Monografia, Dissertação
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\datadefesa{1º de setembro de 2013}
...
\begin{document}
    ...
    % CAPÍTULO 2
    \include{template/elementos_textuais/cap2_novo.tex}
    ...
    % CAPÍTULO 4
    \include{template/elementos_textuais/cap4_novo.tex}
    % \include{template/elementos_textuais/capitulo5.tex}
    %fusao do Capitulo 4 com Capitulo 5

    %CAPÍTULO 5
 
    %CAPÍTULO 6
    \include{template/elementos_textuais/capitulo6.tex}    

    %CAPÍTULO 7
    \include{template/elementos_textuais/capitulo7.tex}

    %CAPÍTULO 8
    \include{template/elementos_textuais/cap8_novo.tex}

    \phantompart

    % CONCLUSÃO
    \include{template/elementos_textuais/cap9_novo.tex}
    ...
    % REFERÊNCIAS
    \include{template/elementos_pos_textuais/referencias}
...
\titulo{Modelo de Otimização para o Escalonamento de Motoristas
no Transporte Rodoviário sob Regulamentação Europeia}
\autor{Francisco Vando Carneiro Moreira}
\data{Novembro, 2025}
%%%%%%%%%%%%%%%%%%%%%%%%%
%%% DADOS PARA A CAPA %%%
...
\begin{document}
    ...
    %CAPÍTULO 8
    %\include{template/elementos_textuais/capitulo8capitulo8.tex}

    \phantompart

    % CONCLUSÃO
    %\include{template/elementos_textuais/capitulo9capitulo9.tex}
    %%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% ELEMENTOS TEXTUAIS %%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%% ELEMENTOS PÓS-TEXTUAIS %%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}/CAPÍTULO 1capitulo1.tex%%/.tex%%%%\include{template/elementos_pos_textuais/glossario.tex}
