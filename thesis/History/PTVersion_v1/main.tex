...
\tipotrabalho{Exame de Qualificação} % Monografia, Dissertação
...
\begin{document}
    ...
    %CAPÍTULO 8
    \include{template/elementos_textuais/capitulo8.tex}

    \phantompart

    % CONCLUSÃO
    \include{template/elementos_textuais/capitulo9.tex}
