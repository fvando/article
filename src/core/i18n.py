...
TRANSLATIONS = {
    "en": {
        ...
        "auth_user": "Username",
        "auth_pass": "Password",
        "auth_error": "😕 User not known or password incorrect",
        ...
        # UI / COMMON
        "loading_opt": "⏳ Optimization in progress... Please wait.",
        ...
        "lbl_ml_train": "Machine Learning – Training",
        ...
        "ml_res_f1_title": "📌 Model f₁ (Assignment)",
        "ml_res_f2_title": "📌 Model f₂ (Neighborhood Ranking)",
        ...
        "lbl_f1_desc": "- f₁ → Driver selection model – period",
        "lbl_f2_desc": "- f₂ → Neighborhood assessment model for LNS",
        ...
        "lbl_ml_dataset": "Machine Learning – Dataset Builder",
        ...
        # MATH TERMS
        "math_unmet_penalty": "Service Deficit Penalty",
        "math_unmet_desc": "Phase 1 priority: penalizes uncovered demand.",
        "math_active_penalty": "Active Resource Minimization",
        "math_active_desc": "Phase 2 goal: reduces total driver activation.",
        "math_task_reward": "Assignment Reward",
        ...
        # LEX OBJECTIVES
        "lex_unmet": "Phase 1: Coverage Deficit Minimization",
        "lex_unmet_desc": "Mathematical priority: maximize service level.",
        "lex_driver_min": "Phase 2: Fleet Optimization",
        "lex_driver_desc": "Minimize active drivers under optimal coverage.",
        "lex_util": "Operational Balance Tie-breaker",
        "lex_util_desc": "Avoid idle activated capacity.",
        "lex_workload": "Workload Equity Smoothing",
        "lex_workload_desc": "Applied after reaching optimal Z and U.",
        ...
        "lbl_const": "Constant",
        "lbl_mult": "Multiplier",
        "btn_bench": "🔬 Run Academic Benchmark",
        "header_bench": "🎓 Comparative Benchmark (Exact vs Heuristic vs LNS)",
        ...
        "chart_op_effort_active_title": "Operational Effort Distribution — Active Drivers",
        ...
        "panel_effort_title": "Operational Effort Analysis Panel — Active Drivers",
        ...
        "eff_warning": "⚠️ **Important:** this indicator represents **operational effort**.\nIt is **not the model's objective**, but an emergent result used\nfor efficiency analysis and regulatory validation.",
        "chart_workload_dist_active_title": "Workload Distribution — Active Drivers",
        ...
        "chart_dem_cap_viol_title": "Demand vs. Allocated Capacity (Violations Highlighted)",
        "chart_dem_cap_title": "Demand vs. Allocated Capacity",
    ...
    "pt": {
        ...
        "auth_restricted": "🔐 Acesso Restrito",

        # MAIN
        "app_title": "Simulador de Alocação de Motoristas",
        "sidebar_nav": "Navegação",

        # UI / COMMON
        "loading_opt": "⏳ Otimizando escalas... Por favor, aguarde.",
        "run_opt": "Executar Otimização",
        "global_params": "Parâmetros Globais",
        "algo_params": "Parâmetros do Algoritmo",

        # SIMULATION - HEADERS
        "sim_title": "Simulação e Otimização",
        "sect_kpis": "KPIs e Métricas",
        "sect_charts": "Gráficos",
        "sect_logs": "Logs do Solver",

        # SIMULATION - INPUTS
        "lbl_horizon": "Horizonte de Planejamento (H)",
        "lbl_slot": "Duração do Slot (min)",
        "lbl_drivers": "Número de Motoristas (0 = Sem limite)",
        "lbl_obj": "Função Objetivo",
        "lbl_symmetry": "Habilitar Symmetry Breaking (Mais lento)",
        "lbl_time": "Tempo Máx (s)",
        "lbl_opt_mode": "Modo de Otimização",
        "lbl_params": "Parâmetros",
        "lbl_mode_select": "Selecionar Modo:",
        "lbl_lns_iter": "Máx Iterações LNS",
        "lbl_max_assign": "Maximizar Atribuição (Robustez)",
        "lbl_elem_ops": "Operações Elementares",
        "lbl_profile_section": "Perfil",
        "lbl_select_profile": "Selecione um perfil de referência (opcional)",
        "sim_main_title": "Simulador",

        # GLOBAL PARAMS COLUMNS
        "col_global": "Global",
        "col_algo": "Algoritmo",
        "col_iter": "Iterações | Relaxamento",
        "col_drivers": "Motoristas / Demandas",
        
        # INPUT LABELS
        "lbl_tolerance": "Tolerância de Cobertura",
        "lbl_variable": "Tipo de Variável",
        "lbl_solver": "GLOP-LP | SCIP-MIP",
        "lbl_density": "Densidade Aceitável",
        "lbl_limit_iter": "Limite de Iterações",
        "lbl_relax": "Nível de Relaxamento",
        "lbl_penalty": "Penalidade por Não Atendimento",
        ...
        # OBJECTIVES & RESTRICTIONS
        "lbl_obj_strat": "Selecione Estratégia de Objetivo",
        "lbl_breakdown": "Detalhamento",
        "lbl_lex_struct": "Estrutura Lexicográfica",
        "lbl_restr": "Restrições",
        "lbl_break_opt": "Opções de Pausa",
        
        # CACHE & ML
        "lbl_cache": "Cache / Persistência",
        "lbl_update_file": "Atualizar Arquivo de Restrições",
        "lbl_ml_mode": "Modo Machine Learning",
        "lbl_ml_train": "Treinamento – Machine Learning",
        ...
        "ml_train_fail_f1": "Modelo f1 não foi treinado.",
        "ml_train_success_f2": "Modelo f2 treinado com sucesso!",
        "ml_train_fail_f2": "Modelo f2 não foi treinado.",
        "ml_acc": "Acurácia:",
        "ml_mse": "MSE:",
        "ml_na": "não disponível.",
        "ml_reason": "Razão não informada.",
        "ml_rows_used": "Linhas usadas:",
        "ml_model_saved": "Modelo salvo em:",
        "ml_res_f1_title": "📌 Modelo f₁ (Atribuição)",
        "ml_res_f2_title": "📌 Modelo f₂ (Ranking de Vizinhança)",
        "ml_training_start": "Iniciando treinamento... isso pode levar alguns minutos.",
        "ml_training_progress": "Treinando modelos f1 e f2...",
        "ml_training_done": "Treinamento concluído!",

        "ml_training_error": "Erro durante o treinamento:",

        # ML TRAINER MESSAGES
        "ml_err_lgbm_missing": "LightGBM não está instalado no ambiente.",
        "ml_err_dataset_missing": "Dataset {0} não encontrado em: {1}. Gere-o primeiro.",
        "ml_err_dataset_read": "Erro ao ler dataset {0}: {1}",
        "ml_err_dataset_empty": "Dataset {0} está vazio. Nenhuma linha para treinar.",
        "ml_err_no_label": "Dataset {0} não contém coluna '{1}'.",
        "ml_err_no_features": "Dataset {0} não possui colunas de features compatíveis (esperadas: {1}).",
        "ml_warn_low_data": "Dataset {0} tem poucas linhas ({1}). Modelo pode ficar fraco.",
        "ml_msg_loaded": "Dataset {0} carregado ({1} linhas).",
        "ml_msg_train_success": "Treino concluído com sucesso.",
        "ml_err_train": "Erro ao treinar LightGBM {0}: {1}",
        "ml_err_acc": "Erro ao calcular acurácia de {0}: {1}",
        "ml_err_mse": "Erro ao calcular MSE de {0}: {1}",
        "ml_err_save": "Erro ao salvar modelo {0} em {1}: {2}",
        
        "lbl_num_instances": "Número de Instâncias",
        "lbl_periods_per_inst": "Períodos por instância",
        "lbl_drivers_limit": "Motoristas (limite)",
        "lbl_max_periods_driver": "Máx. períodos por motorista",
        "lbl_min_demand": "Demanda mínima por período",
        "lbl_max_demand": "Demanda máxima por período",
        "lbl_seed": "Semente Aleatória (Seed)",
        "lbl_f1_desc": "- f₁ → Modelo de seleção de motoristas – período",
        "lbl_f2_desc": "- f₂ → Modelo de avaliação de vizinhança para LNS",
        "lbl_dataset_note": "Nota: Instâncias pequenas são recomendadas para resolver (Exact). (Ex: 24 períodos e 10 motoristas).",
        "btn_gen_dataset": "Gerar Dataset ML (f1 & f2)",
        
        "msg_gen_inst": "Gerando instância {0} de {1}...",
        "msg_solver_error": "Instância {0}: erro ao resolver (Exact) → {1}",
        "msg_solver_invalid": "Instância {0}: solver não retornou matriz válida.",
        "msg_norm_fail": "Instância {0}: normalização falhou. Ignorada.",
        "msg_dataset_success": "Datasets gerados com sucesso!",
        "ml_gen_done": "Concluído!",
        ...
        "opt_integer": "Inteiro",
        "opt_binary": "Binário",
        "opt_continuous": "Contínuo",
        "opt_exact": "Exato",
        "opt_heuristic": "Heurística",
        "opt_lns": "LNS (Busca em Vizinhança)",
        "opt_none": "Nenhuma",
        "opt_45_min": "45 minutos",
        "opt_15_30": "Divisão 15+30",
        "opt_30_15": "Divisão 30+15",
        
        # MATH TERMS
        "math_unmet_penalty": "Penalização por Défice de Serviço",
        "math_unmet_desc": "Prioridade da Fase 1: penaliza demanda não coberta.",
        "math_active_penalty": "Minimização de Recursos Ativos",
        "math_active_desc": "Objetivo da Fase 2: reduz ativação total de motoristas.",
        "math_task_reward": "Recompensa por Atribuição",
        
        # INTERPRETER & ENGINE
        "interp_title": "Interpretação do Resultado",
        "interp_op_eff": "Eficiência Operacional",
        "interp_model_struct": "Estrutura do Modelo",
        "interp_solver_behavior": "Comportamento do Solver",
        "interp_service_quality": "Nível de Serviço / Qualidade",
        "interp_op_effort": "Esforço Operacional",
        "interp_no_effort": "Nenhum esforço operacional registrado (0 motoristas ativos).",
        "interp_effort_caption": "Motoristas ativos: **{0}**\nEsforço médio: **{1:.2f} h**\nMediana: **{2:.2f} h**\nP90 / P95: **{3:.2f} h / {4:.2f} h**\nÍndice de Gini: **{5:.3f}**\n\n⚠️ O painel apresenta indicadores de **esforço operacional agregado**.\nA referência de 9h é indicativa e não representa, isoladamente,\nverificação direta de conformidade legal.",

        # ENGINE MESSAGES
        "eng_err_interp": "Erro ao interpretar resultados.",
        "eng_opt_proven": "Solução ótima comprovada (gap ≤ 1%).",
        "eng_opt_likely": "Solução com prova de otimalidade no critério do solver (gap ~ {0:.2f}% se disponível).",
        "eng_feasible": "Solução viável encontrada, sem prova de otimalidade.",
        "eng_infeasible": "Modelo inviável com as restrições atuais.",
        "eng_unknown": "Estado do solver não identificado no resumo.",
        "eng_heuristic_state": "Solução Heurística (Greedy) - gerada sem solver.",
        "eng_opt_likely": "Solução com prova de otimalidade no critério do solver (gap ~ {0:.2f}% se disponível).",
        "eng_feasible": "Solução viável encontrada, sem prova de otimalidade.",
        "eng_infeasible": "Modelo inviável com as restrições atuais.",
        "eng_unknown": "Estado do solver não identificado no resumo.",
        
        "eng_gap_none": "Gap não informado; avaliar por métricas operacionais e consistência das restrições.",
        "eng_gap_high": "Gap {0:.2f}% (alto): pode haver melhoria considerável com mais tempo.",
        "eng_gap_mod": "Gap {0:.2f}% (moderado): aceitável em operação, mas refinável.",
        "eng_gap_low": "Gap {0:.2f}% (baixo): solução muito boa.",
        
        "eng_model_desc": "Modelo de Programação Inteira Mista (MIP) com variáveis binárias de alocação Y[d,t] e variáveis de ativação de motorista Z[t].",
        "eng_constr_active": "Total de restrições ativas no modelo: {0}.",
        "eng_bnb_desc": "O solver utilizou um algoritmo de Branch-and-Bound com relaxações lineares e heurísticas internas.",
        "eng_opt_reached": "O solver atingiu otimalidade comprovada.",
        "math_task_desc": "Incentiva maior utilização dos motoristas ativos.",
        "math_presence_min": "Minimização de Presença",
        "math_presence_desc": "Reduz tempo de presença desnecessário.",
        "math_overload": "Balanceamento de Carga",
        "math_overload_desc": "Equilibra carga excessiva por motorista.",
        "math_smoothing": "Suavização de Carga Máxima",
        "math_smoothing_desc": "Evita concentração de carga num único motorista.",
        "math_minimize_drivers": "Minimizar Número Total de Motoristas",
        "math_role_primary": "Primário (Fase 1)",
        "math_role_secondary": "Secundário (Fase 1)",
        "math_role_tie": "Desempate",
        "math_role_phase2": "Fase 2",

        # RESTRICTIONS & PROFILES
        "restr_cov_desc": "Necessidade de Cobertura",
        "restr_cov_det": "O número de trabalhadores alocados deve satisfazer a demanda mínima do período i.",
        "restr_daily_desc": "Limite Diário de Direção",
        "restr_daily_det": "Pode ser 40 períodos (10h) duas vezes por semana.",
        "restr_break45_desc": "Pausa 45min após 4.5h",
        "restr_break45_det": "Após máx. 18 períodos (4.5h), deve haver pausa de 3 períodos (45 min).",
        "restr_rest_daily_desc": "Repouso Diário Mínimo",
        "restr_rest_daily_det": "O motorista deve descansar pelo menos 44 períodos (11h) a cada dia.",
        "restr_rest_weekly_desc": "Repouso Semanal",
        "restr_rest_weekly_det": "O motorista deve ter um repouso de 180 períodos (45h) a cada semana.",
        "restr_rest_after_work_desc": "Descanso após 6 dias",
        "restr_rest_after_work_det": "O descanso semanal deve ser gozado após seis dias consecutivos de trabalho.",
        "restr_weekly_limit_desc": "Limite Semanal de Direção",
        "restr_weekly_limit_det": "O número total de períodos de trabalho na semana não pode exceder 224 (56h).",
        "restr_biweekly_limit_desc": "Limite Quinzenal de Direção",
        "restr_biweekly_limit_det": "O número total de períodos de trabalho em duas semanas não pode exceder 360 (90h).",
        "restr_rest_reduced_desc": "Repouso Diário Reduzido",
        "restr_rest_reduced_det": "O repouso pode ser reduzido para 36 períodos (9h), máx 3 vezes em 14 dias.",
        "restr_rest_biweekly_desc": "Repouso Quinzenal",
        "restr_rest_biweekly_det": "O motorista deve ter um repouso de 96 períodos (24h) a cada duas semanas.",
        
        # PROFILES
        "prof_sanity": "Validação do modelo (cobertura + gráficos, sem regras legais)",
        "prof_operational": "Operacional diário UE (core)",
        "prof_strict": "Operacional diário rígido (repouso mínimo)",
        "prof_flex": "Operacional diário flexível (repouso reduzido permitido)",
        "prof_weekly_core": "Planejamento semanal (limite semanal)",
        "prof_weekly_strict": "Planejamento semanal rígido (descanso semanal)",
        ...
        "col_uncovered": "Não Coberto",
        "col_avg_load": "Carga Média",
        "col_var_load": "Variância de Carga",
        "col_global_cov": "Cobertura Global",
        "col_efficiency": "Eficiência",
        "col_risk": "Risco Operacional",
        "col_stability": "Estabilidade",
        "lbl_preview_f1": "Pré-visualização f1 (Atribuição):",
        "lbl_preview_f2": "Pré-visualização f2 (Vizinhança):",
        
        # LEX OBJECTIVES
        "lex_unmet": "Fase 1: Minimização do Défice de Cobertura",
        "lex_unmet_desc": "Prioridade matemática: maximizar nível de serviço.",
        "lex_driver_min": "Fase 2: Otimização da Frota Ativa",
        "lex_driver_desc": "Minimizar motoristas ativos sob cobertura ótima.",
        "lex_util": "Desempate por Equilíbrio Operacional",
        "lex_util_desc": "Evitar capacidade ativa ociosa.",
        "lex_workload": "Suavização e Equidade de Carga",
        "lex_workload_desc": "Aplicado após atingir U e Z ótimos.",
        "op_swap": "Troca de Equações",
        "op_mult": "Multiplicação por Constante",
        "op_sum": "Soma de Múltiplo",
        "lbl_row": "Linha",
        "lbl_row_1": "Linha 1",
        "lbl_row_2": "Linha 2",
        "lbl_base": "Linha Base",
        ...
        "btn_bench": "🔬 Executar Benchmark Acadêmico",
        "header_bench": "🎓 Benchmark Comparativo (Exato vs Heurística vs LNS)",

        # RESULTS
        "res_active_drivers": "Motoristas Ativos",
        "res_assigned_slots": "Slots Alocados",
        "res_service_level": "Nível de Serviço",
        "res_opt_gap": "Gap de Otimalidade",
        "msg_no_active": "Nenhum motorista ativo na solução.",
        "msg_opt_error": "Erro durante a otimização:",

        # CHARTS
        "chart_effort": "Esforço Operacional por Motorista",
        "chart_heatmap": "Taxa de Cobertura por Slot",
        "chart_safety": "Margem de Segurança (Motoristas - Demanda)",
        "chart_kpi": "Comparação de KPIs",

        # CHART TITLES & LABELS
        "chart_gap_title": "Déficit de Demanda por Período",
        "chart_gap_total": "Déficit Total",
        "chart_gap_max": "Pior Slot",
        "chart_gap_slots": "Slots com Déficit",
        "chart_gap_yaxis": "Déficit (tarefas)",
        
        "chart_demand_served_title": "Demanda vs Atendimento Real (por período)",
        "chart_demand_label": "Demanda (tarefas)",
        "chart_served_label": "Atendimento Real (tarefas)",
        "chart_deficit_label": "Déficit",
        
        "chart_cap_util_title": "Capacidade Alocada vs Utilização",
        "chart_cap_alloc_label": "Capacidade Alocada (tarefas)",
        "chart_util_label": "Utilização (0-1)",
        "chart_util_yaxis": "Utilização",
        
        "chart_demand_curve_title": "Curva de Demanda ao Longo do Horizonte",
        "chart_demand_req_label": "Demanda Requerida",
        
        "chart_cov_title": "Cobertura da Demanda por Período",
        "chart_drivers_alloc_label": "Motoristas Alocados (Capacidade)",
        "chart_cov_deficit_label": "Déficit de Cobertura",
        
        "chart_driv_ecdf_title": "ECDF — Condução (UE)",
        "chart_driv_box_title": "Boxplot — Condução (UE)",
        "chart_driv_xaxis": "Horas de Condução",
        
        "chart_shift_ecdf_title": "ECDF — Turno (Presença)",
        "chart_shift_box_title": "Boxplot — Turno (Presença)",
        "chart_shift_xaxis": "Horas de Turno",
        
        "chart_gap_cov_title": "Gap de Cobertura (Motoristas − Demanda)",
        "chart_gap_cov_yaxis": "Gap de Cobertura",
        "chart_gap_violations": "Slots com Violação",
        "chart_gap_worst": "Pior Gap",
        
        "chart_dem_cap_util_title": "Demanda vs Capacidade vs Atendimento Real",
        "chart_util_cap_label": "Utilização da Capacidade",
        
        "chart_dem_drivers_title": "Demanda vs Motoristas Alocados",
        "chart_drivers_label": "Motoristas Alocados",
        
        "axis_time_hours": "Tempo (horas)",
        "axis_slot": "Período (slot)",
        "axis_tasks": "Tarefas",
        "axis_qty": "Quantidade",
        "axis_prob": "Proporção Acumulada",
        "axis_hours": "Horas",
        
        # OPERATIONAL EFFORT CHARTS
        "chart_op_effort_title": "Distribuição do Esforço Operacional por Motorista",
        "msg_chart_unavailable_matrix": "Gráfico indisponível: matrix_allocation é None.",
        "msg_chart_invalid_matrix": "Gráfico indisponível: matriz de alocação inválida.",
        "legend_worked_hours": "Horas trabalhadas",
        "legend_limit_daily": "Limite diário legal",
        "legend_avg_observed": "Média observada",
        "axis_driver": "Motorista",
        "axis_hours_worked_horizon": "Horas trabalhadas no horizonte",
        "chart_op_effort_active_title": "Distribuição do Esforço Operacional — Motoristas Ativos",
        "axis_active_drivers_sorted": "Motoristas ativos (ordenados por carga)",
        "axis_active_drivers_sorted": "Motoristas ativos (ordenados por carga)",
        "axis_workload_hours": "Carga de trabalho (horas)",
        "legend_assigned_load": "Carga atribuída (horas)",
        
        "chart_ecdf_effort_title": "ECDF do Esforço Operacional",
        "chart_dispersion_title": "Dispersão do Esforço",
        "chart_equity_title": "Equidade do Esforço Operacional",
        "legend_lorenz_curve": "Curva de Lorenz",
        "legend_equitable_dist": "Distribuição equitativa",
        "axis_prop_drivers": "Proporção acumulada de motoristas",
        "axis_prop_load": "Proporção acumulada da carga",
        "axis_total_load_driver": "Carga total por motorista (h)",
        "panel_effort_title": "Painel de Análise do Esforço Operacional — Motoristas Ativos",
        
        "chart_inactive_drivers": "Motoristas Inativos",
        "chart_active_drivers": "Motoristas Ativos",
        "axis_assigned_slots": "Slots atribuídos",
        "axis_num_drivers": "Nº de motoristas",
        "chart_load_dist_title": "Distribuição de Carga por Motorista",

        # OPERATIONAL EFFORT
        "eff_total_slots": "Total de slots atribuídos: {0}",
        "eff_total_hours_simple": "Total de horas de trabalho: {0:.2f} h",
        "eff_active_drivers": "Motoristas ativos: {0}",
        "eff_avg_effort": "Esforço médio: {0:.2f} h por motorista",
        ...
        "eff_slot_duration": "Duração por slot: **{0} minutos**",
        "eff_total_hours_bold": "Total de horas trabalhadas: **{0:.2f} h**",
        "eff_avg_desc": "Em média, cada motorista trabalhou aproximadamente **{0:.2f} h**.\nconsiderando a flexibilidade residual decorrente da não ativação do\nrepouso diário mínimo neste cenário.",
        "eff_warning": "⚠️ **Importante:** este indicador representa **esforço operacional**.\nEle **não é o objetivo do modelo**, mas um resultado emergente utilizado\npara análise de eficiência e validação regulatória.",
        "chart_workload_dist_active_title": "Distribuição da Carga de Trabalho — Motoristas Ativos",
        "axis_total_slots_driver": "Total de slots atribuídos ao motorista",
        "label_assigned_drivers_cap": "Motoristas Alocados (Capacidade)",
        "label_req_drivers_dem": "Motoristas Requeridos (Demanda)",
        "label_dem_deficit": "Déficit de Demanda",
        "chart_gap_slots": "Slots com Déficit",
        "chart_gap_total": "Carga Total de Déficit",
        "chart_gap_max": "Déficit Máximo por Slot",
        "chart_gap_yaxis": "Volume de Déficit (Tarefas)",
        "chart_equity_title": "Distribuição de Carga (Lorenz)",
        "axis_prob": "Probabilidade Acumulada",
        "axis_prop_drivers": "Proporção de Motoristas",
        "axis_prop_load": "Proporção de Carga",
        "legend_lorenz_curve": "Curva de Lorenz (Real)",
        "legend_equitable_dist": "Igualdade Perfeita (Teórica)",
        "panel_effort_title": "Análise de Esforço Operacional e Equidade",
        "chart_ecdf_effort_title": "Distribuição Acumulada de Carga (ECDF)",
        "chart_dispersion_title": "Dispersão da Carga Diária",
        "chart_active_drivers": "Motoristas Ativos",
        "axis_total_load_driver": "Carga Total (horas)",
        "chart_dem_cap_viol_title": "Demanda vs. Capacidade Alocada (Violações Destacadas)",
