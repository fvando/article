...
def solve_shift_schedule(need, variable_type):
...
if st.button("Executar Otimização"):
    ...
    try:
        ...
        if len(need) != num_periods:
            ...
            total_workers, workers_schedule, constraint_matrix, density, visible_output, detailed_output, model_class = solve_shift_schedule(need, variable_type)
